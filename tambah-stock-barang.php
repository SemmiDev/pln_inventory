                ...
                <form action="tambah-stock-barang.php" method="post" class="max-w-lg mt-8">
                    ...
                    <fieldset class="w-full space-y-2 dark:text-gray-100">
                        ...
                        <div class="flex">
                            ...
                            <input type="text" value="<?php echo $data['material_description']; ?>" disabled required name="material_desc" id="material_desc" placeholder="TRF DIS XXX 1999" class="flex flex-1 p-3 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                        </div>
                        <div class="flex">
                            <div class="flex flex-wrap items-center px-3 pointer-events-none w-28 sm:text-sm rounded-l-md dark:bg-gray-700">
                                Stock SAP</div>
                            <input value="<?php echo $data['stock_sap']; ?>" type="number" disabled required name="stock_sap" id="url" placeholder="35" class="flex flex-1 p-3 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                        </div>
                        <div class="flex">
                            <div class="flex flex-wrap items-center px-3 pointer-events-none w-28 sm:text-sm rounded-l-md dark:bg-gray-700">
                                Barang Masuk</div>
                            <input type="number" required autofocus name="barang_masuk" id="url" placeholder="35" class="flex flex-1 p-3 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                        </div>
                    </fieldset>
