            ...
            <div class="p-5 bg-white rounded-lg mt-11">
                ...
                <form action="edit-barang.php" method="post" class="max-w-lg mt-8">
                    <fieldset class="w-full space-y-2 dark:text-gray-100">
                        ...
                        <div class="flex">
                            <div
                                class="flex flex-wrap items-center px-3 pointer-events-none w-28 sm:text-sm rounded-l-md dark:bg-gray-700">
                                Kode Material</div>
                            <input autofocus type="text" value="<?php echo $data['material_code']; ?>" required
                                name="material_code" id="url" placeholder="0001321301231"
                        ...
                        <div class="flex">
                            <div
                                class="flex flex-wrap items-center px-3 pointer-events-none w-28 sm:text-sm rounded-l-md dark:bg-gray-700">
                                Nama Material</div>
                            <input autofocus type="text" value="<?php echo $data['material_name']; ?>" required
                                name="material_name" id="url" placeholder="0001321301231"
                                class="flex flex-1 p-3 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                        </div>
                        ...
                        <div class="flex">
                            ...
                            <input type="text" value="<?php echo $data['material_description']; ?>" required
                                name="material_description" id="material_description" placeholder="TRF DIS XXX 1999"
                                class="flex flex-1 p-3 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                        </div>
                        ...
                        <div class="flex">
                            <div
                                class="flex flex-wrap items-center px-3 pointer-events-none w-28 sm:text-sm rounded-l-md dark:bg-gray-700">
                                Material Group</div>
                            <input type="text" value="<?php echo $data['material_group']; ?>" required
                                name="material_group" id="url" placeholder="XM12312"
                                class="flex flex-1 p-3 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                        </div>
                        <div class="flex">
                            <div
                            ...
                            <input type="text" value="<?php echo $data['base_unit_of_measure']; ?>" required
                                name="base_unit_of_measure" id="url" placeholder="U"
                                class="flex flex-1 p-3 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                        </div>
                        ...
                        <div class="flex">
                            <div
                                class="flex flex-wrap items-center px-3 pointer-events-none w-28 sm:text-sm rounded-l-md dark:bg-gray-700">
                                Valuation Type</div>
                            <input type="text" value="<?php echo $data['valuation_type']; ?>" required
                                name="valuation_type" id="url" placeholder="Normal"
                                class="flex flex-1 p-3 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                        </div>
                        <div class="flex">
                            <div
                                class="flex flex-wrap items-center px-3 pointer-events-none w-28 sm:text-sm rounded-l-md dark:bg-gray-700">
                                Stock SAP</div>
                            <input type="number" value="<?php echo $data['stock_sap']; ?>" required name="stock_sap"
                                id="url" placeholder="35"
                                class="flex flex-1 p-3 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                        </div>
                    </fieldset>
                    ...
                    <div class="flex items-center justify-center gap-2 mt-8">
                        <button type="submit" name="submit"
                            class="px-5 py-4 font-semibold text-white transition duration-200 ease-linear border-2 rounded-lg bg-sky-400 hover:bg-sky-600 border-sky-400">Simpan
                            Perubahan</button>
                        <a href="index.php">
                            <button type="button"
                                class="px-5 py-4 font-semibold text-white transition duration-200 ease-linear bg-red-400 border-2 border-red-400 rounded-lg hover:bg-red-600">Batal</button>
                        </a>
                    </div>
                </form>
