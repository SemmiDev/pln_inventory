                ...
                <form action="edit-barang.php" method="post" class="max-w-lg mt-8">
                    <fieldset class="w-full space-y-2 dark:text-gray-100">
                        ...
                        <div class="flex">
                            ...
                            <input autofocus type="text" value="<?php echo $data['material_code']; ?>" required name="material_code" id="url" placeholder="0001321301231" class="flex flex-1 p-3 border sm:text-lg rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                        </div>
                        ...
                        <div class="flex">
                            ...
                            <input type="text" value="<?php echo $data['material_description']; ?>" required name="material_description" id="material_description" placeholder="TRF DIS XXX 1999" class="flex flex-1 p-3 border sm:text-lg rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                        </div>
                        ...
                        <div class="flex">
                            ...
                            <input type="text" value="<?php echo $data['material_group']; ?>" required name="material_group" id="url" placeholder="XM12312" class="flex flex-1 p-3 border sm:text-lg rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                        </div>
                        <div class="flex">
                            <div class="flex flex-wrap items-center px-3 pointer-events-none w-44 sm:text-lg rounded-l-md dark:bg-gray-700">
                                Base Unit of Measure
                            </div>
                            <input type="text" value="<?php echo $data['base_unit_of_measure']; ?>" required name="base_unit_of_measure" id="url" placeholder="U" class="flex flex-1 p-3 border sm:text-lg rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                        </div>
                        ...
                        <div class="flex">
                            ...
                            <input type="text" value="<?php echo $data['valuation_type']; ?>" required name="valuation_type" id="url" placeholder="Normal" class="flex flex-1 p-3 border sm:text-lg rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                        </div>
                    </fieldset>
