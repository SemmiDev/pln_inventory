            ...
            <div class="divide-y divide-gray-700">
                <ul class="pt-2 pb-4 space-y-1 text-sm">
                    ...
                    <li class="border-l-2 dark:bg-gray-800 border-sky-400 dark:text-gray-50">
                        <a rel="noopener noreferrer" href="surat-jalan.php"
                            class="flex items-center p-2 space-x-3 rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                class="w-5 h-5 fill-current dark:text-gray-400">
                                <path
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="cetak.php">
                    <button type="submit" onclick='return confirmDelete()'
                        class="px-5 py-4 font-semibold text-white transition duration-200 ease-linear bg-purple-400 border-2 border-purple-400 rounded-lg hover:bg-purple-600">Simpan
                        & Cetak
                        PDF</button>
                ...
                <div class="p-5 mt-2 bg-white rounded-lg">
                    <div class="max-w-[400px]">
                        <fieldset class="w-full space-y-2 dark:text-gray-100">
                            <div class="flex">
                                <div
                                    class="flex flex-wrap items-center px-3 pointer-events-none w-36 sm:text-sm rounded-l-md dark:bg-gray-700">
                                    Tanggal</div>
                                <input type="date" onchange="handleChangeInput(event)" required name="created_at"
                                    id="created_at" placeholder="0001321301231"
                                    class="flex flex-1 p-3 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                            </div>
                            ...
                            <div class="flex">
                                <div
                                    class="flex flex-wrap items-center px-3 pointer-events-none w-36 sm:text-sm rounded-l-md dark:bg-gray-700">
                                    Nomor Surat</div>
                                <input type="text" onchange="handleChangeInput(event)" required name="letter_number"
                                    id="letter_number" placeholder="150/LOG/SB - II / 2023"
                                    class="flex flex-1 p-3 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                            </div>
                            ...
                            <div class="flex">
                                <div
                                    class="flex flex-wrap items-center px-3 pointer-events-none w-36 sm:text-sm rounded-l-md dark:bg-gray-700">
                                    Kepada</div>
                                <input type="text" onchange="handleChangeInput(event)" required name="letter_to"
                                    id="letter_to" placeholder="Petugas Keamanan"
                                    class="flex flex-1 p-3 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                            </div>
                            ...
                            <div class="flex">
                                <div
                                    class="flex flex-wrap items-center px-3 pointer-events-none w-36 sm:text-sm rounded-l-md dark:bg-gray-700">
                                    Untuk</div>
                                <input type="text" onchange="handleChangeInput(event)" required name="letter_for"
                                    id="letter_for" placeholder="PEK Jardus"
                                    class="flex flex-1 p-3 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                            </div>
                            ...
                            <div class="flex">
                                <div
                                    class="flex flex-wrap items-center px-3 pointer-events-none w-36 sm:text-sm rounded-l-md dark:bg-gray-700">
                                    Berdasarkan</div>
                                <input type="text" onchange="handleChangeInput(event)" required name="based_on"
                                    id="based_on" placeholder="XXX"
                                    class="flex flex-1 p-3 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                            </div>
                            ...
                            <div class="flex">
                                ...
                                <input type="text" onchange="handleChangeInput(event)" required
                                    name="contract_spk_factur" id="contract_spk_factur" placeholder="SPK 157.XX"
                                    class="flex flex-1 p-3 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                            </div>
                            ...
                            <div class="flex">
                                <div
                                    class="flex flex-wrap items-center px-3 pointer-events-none w-36 sm:text-sm rounded-l-md dark:bg-gray-700">
                                    TUG-8 & TUG-9</div>
                                <input type="text" onchange="handleChangeInput(event)" required name="tug8_tug9"
                                    id="tug8_tug9" placeholder="34223"
                                    class="flex flex-1 p-3 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                            </div>
                            ...
                            <div class="flex">
                                <div
                                    class="flex flex-wrap items-center px-3 pointer-events-none w-36 sm:text-sm rounded-l-md dark:bg-gray-700">
                                    Dibawa Dengan</div>
                                <input type="text" onchange="handleChangeInput(event)" required name="delivery_with"
                                    id="delivery_with" placeholder="PT Mega Distribusi"
                                    class="flex flex-1 p-3 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                            </div>
                    ...
                    <div class="max-w-[400px] space-y-2">
                        ...
                        <div class="flex">
                            <div
                                class="flex flex-wrap items-center px-3 pointer-events-none w-36 sm:text-sm rounded-l-md dark:bg-gray-700">
                                Jumlah Keluar</div>
                            <input type="number" id="jumlah_keluar" required name="valuation_type" placeholder="10"
                                class="flex flex-1 p-3 border sm:text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-100 dark:bg-gray-800 focus:ring-violet-400">
                        </div>

                        <div class="flex justify-end">
                            <button onclick="addMaterial()" type="button" id="tambah-material"
                                class="px-8 py-3 mt-5 font-semibold text-white transition duration-300 bg-black border rounded-lg hover:text-black hover:bg-white hover:border-black">Tambah</button>
                        </div>
                    </div>
                </div>
    ...
    function loadMaterialFirst() {
        ...
        for (var i = 0; i < input.barang_keluar.length; i++) {
            ...
            <div class="relative p-3 space-y-2 border border-black rounded-lg">
                ...
                <div class="flex">
                    <div class="flex flex-wrap items-center px-3 bg-gray-300 pointer-events-none w-36 sm:text-sm rounded-l-md font-semibold dark:bg-gray-700">Jumlah Keluar</div>
