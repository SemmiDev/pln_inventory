                ...
                <div class="flex gap-2 items-center">
                    ...
                    <?php
                            if (isset($_GET['search'])) {
                                ...
                                echo "<span class=' text-pink-400 text-sm font-semibold dark:text-gray-500'>(terdapat " . mysqli_num_rows($query) . " hasil pencarian untuk keyword '$keyword')</span>";
                            }
                            ?>
                </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex gap-5 items-center">
                        ...
                        if (isset($_GET['status'])) {
                            $status = $_GET['status'];
                            echo "<span class='text-sm text-sky-600 font-semibold'>$status</span>";
                        }
                        ?>
                    </div>
